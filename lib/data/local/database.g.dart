...
class $TaskTagsTable extends TaskTags
  ...
  @override
  List<GeneratedColumn> get $columns => [id, taskId, tagId, isDeleted];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class TaskTagEntity extends DataClass implements Insertable<TaskTagEntity> {
  ...
  @override
  int get hashCode => Object.hash(id, taskId, tagId, isDeleted);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $$TaskTagsTableTableManager
    extends
        RootTableManager<
          ...
          (
            TaskTagEntity,
            BaseReferences<_$AppDatabase, $TaskTagsTable, TaskTagEntity>,
          ),
          TaskTagEntity,
          PrefetchHooks Function()
        > {
